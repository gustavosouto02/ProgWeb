var meuElemento = document.getElementById("paragrafo"); // elemento mais específico
console.log(meuElemento);
console.log(meuElemento.textContent);

var paragrafo1 = document.getElementsByClassName("paragrafo"); // um grupo de elementos
...
var paragrafo2 = document.getElementsByTagName("p"); // um grupo maior de elemento

for (let i = 0; i <paragrafo2.length; i++){
    console.log(paragrafo2[i].textContent);
}

var cabecalho1 = document.querySelector(".cabecalho"); //apenas o primeiro elemento que ele encontrar
console.log(cabecalho1.textContent);

var cabecalho2 = document.querySelectorAll(".cabecalho"); //todos os elemento que ele encontrar
